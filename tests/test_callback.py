...
class TestCallback:
    ...
    @pytest.mark.asyncio
    async def test_image_message(self, connection, callback_send, callback_receive, server):
    ...
    @pytest.mark.asyncio
    async def test_file_message(self, connection, callback_send, callback_receive, server):
